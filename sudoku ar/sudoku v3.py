# coding:utf-8
'''
sudoku augmented reality v0.3 with python
solver from web
winxos 2016-03-31
'''
import cv2
...
class board:
    ...
    def get_state(self,img):
        ...
        for i in xrange(9):
            for j in xrange(9):
                cv2.rectangle(img,(i*gapw+margin,j*gapw+margin),(i*gapw+gapw-margin,j*gapw+gapw-margin),(0,0,0),1)
